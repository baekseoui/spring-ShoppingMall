...
<link rel="stylesheet" href="../css/searchqnaEdit.css">
<script
                    ...
                    <ul class="list_snb">
                        <li>
                            ...
                            <ul class="list_snb_sub">
                                ...
                                <li>
                                    <a href="index8.jsp" class="link_snb_sub">상품 리뷰</a>
                                </li>
                                <!-- <li>
                        ...
                        <li>
                            ...
                            <ul class="list_snb_sub">
                                ...
                                <li>
                                    <a href="../member/customer_service.jsp" class="link_snb_sub" spcid="MYCJ____left__foodstp__">FAQ</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
								...
								<tr class="hide">
									<td colspan="3">
										<div class="item_name">
											...
											<a href="#">라이프썸 무선 BLDC 선풍기 (LFS-HA27)</a>
										</div>
										<div class="item_img">
									...
									<td colspan="3">
										<form action="indexSearch.jsp">
											<div class="q-cus">
												<span class="icon-q">Q</span>
												<textarea cols='100' rows='5' class="edit_text">판매자님 신선하고 좋은 상품으로 부탁드립니다.</textarea>
											</div>
											<div class="a-sel">
												<span class="icon-a">A</span> 고객님 안녕하세요.<br> 고객게시판
												운영자입니다.<br> 좋은 상품으로 안전하게 배송해드리겠습니다.<br> 항상 건강 유의하시고
												편안한 하루 보내세요.<br>
											</div>
											<p class="reginfo">
											...
											<div class="review_control">
												<input type='submit' id='edit_submit' value='수정'>
											</div>
										</form>
									</td>
								</tr>
