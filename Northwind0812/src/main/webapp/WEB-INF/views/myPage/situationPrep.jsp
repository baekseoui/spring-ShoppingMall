		...
		<div class="select_search_date _order_list_search">
			<div class="search_selectbx _search_date">
				<select title="선택옵션" class="u_d_sel _search_date_select">
					...
					<option value="2020" startdate="20200101" enddate="20200618">
						2020년 (2020.01.01 ~ 2020.06.18)</option>
				...
				<div class="box_wrap">
					...
					<div class="box_prod">
						...
						<div class="prod_details">
							<span class="txt_state">상품준비중</span> <strong class="tit_prod">
								<a
								href="http://display.cjmall.com/p/item/61409113?channelCode=30001001&amp;isMyzone=true"
						...
						<div class="btn_area">
							<div class="inner">
								<button type="button" class="u_btn _cancel_btn _buttonLinkUrl"
									data-link-value="orderCancelV2">주문취소</button>
