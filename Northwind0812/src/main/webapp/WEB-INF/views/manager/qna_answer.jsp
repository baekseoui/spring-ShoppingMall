...
<body>
	...
	<div id="wrap">
		...
		<form action="qna_answer_table.do" method="get" accept-charset="UTF-8">
			...
			<c:forEach items="${qna_dto }" var="qna">
				<table class="qna_answer_table">
					<tr id="title">
						...
						<input type="hidden" name="customerID" value="${sessionScope.login_Id}">
					...
					<tr>
						<th>내용</th>
						<td><input type="text" value="${qna.boardContent }" style='width: 600px; height: 200px; background-color:transparent;border:0 solid black;'
						disabled></td>
		...
		<div id="qna_answer_div2">
			<table class="qna_answer_table">

				<tr>
					<th colspan="2"><h4>답변등록</h4></th>
				</tr>
				<tr>
					<th>제목</th>
					<td><input type="text" placeholder="답변입니다." style="border: none" name="qna_reply_title"></td>
				</tr>
				<tr>
					<th>내용</th>
					<td><textarea class="content" placeholder="답변내용" title="답변내용" name="qna_reply"
		...
		<div id="answer_button">
			<input type="submit" name="answer_button" value="답변등록">
		</div>
		</form>	
		<!--    	<div id="qna_header">
